...
EtiquetteR::create_pdf(file_out = file_out,  ind_list = individuals , print_info = print_informations, lab_size = 15, n_col = 8, col_N_name = "N", hl_col = "orange") # Write a Latex file and create corresponding pdf
